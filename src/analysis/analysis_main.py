...
parser.add_argument("-rm", "--reward_mode", type=st r, help="Choose reward mode, individual hormone secretion or total hormone secretion, ['local', 'global']")
...
if __name__=="__main__":
    ...
    while(True):
        analysis_type = input("Input which you want to experiment [score, hormone, glucose, sync, exit]: ")
        if analysis_type == "score":
            experiment.score()
        elif analysis_type == "hormone":
